...
// // import Footer from './footer'; // Assuming Footer is a separate component and not directly related to this issue
// // import { Button } from '@mui/material'; // No longer needed for this specific problem area
...
//                             </motion.button>
//                         ) : (
//                             <div className="flex items-center space-x-6"> {/* Use a simple div for layout */}
...
//                 </div>
//             </motion.nav>
//             {/* If Footer is meant to be here, keep it, otherwise remove */}
//             {/* <Footer /> */}
//         </>
//     );
// };
          ...
          <div className="flex items-center justify-between h-20">
            ...
            {location.pathname === "/input" ? (
              ...
              <div className="flex items-center space-x-6">
                ...
                {userId ? (
                  <>
                    <span className="text-sm text-white">Welcome, {userId}</span>
                    <motion.button
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
